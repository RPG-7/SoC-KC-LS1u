...
#define NAME_TABLE_V_MASK (BYTE)2
#define NAME_TABLE_H_MASK (BYTE)1

/* Sprite RAM */
extern BYTE SPRRAM[];

#define SPR_Y    (BYTE)0
#define SPR_CHR  (BYTE)1
#define SPR_ATTR (BYTE)2
#define SPR_X    (BYTE)3
#define SPR_ATTR_COLOR  (BYTE)0x3
#define SPR_ATTR_V_FLIP (BYTE)0x80
#define SPR_ATTR_H_FLIP (BYTE)0x40
#define SPR_ATTR_PRI    (BYTE)0x20
...
#define R0_NMI_VB      (BYTE)0x80
#define R0_NMI_SP      (BYTE)0x40
#define R0_SP_SIZE     (BYTE)0x20
#define R0_BG_ADDR     (BYTE)0x10
#define R0_SP_ADDR     (BYTE)0x08
#define R0_INC_ADDR    (BYTE)0x04
#define R0_NAME_ADDR   (BYTE)0x03

#define R1_BACKCOLOR   (BYTE)0xe0
#define R1_SHOW_SP     (BYTE)0x10
#define R1_SHOW_SCR    (BYTE)0x08
#define R1_CLIP_SP     (BYTE)0x04
#define R1_CLIP_BG     (BYTE)0x02
#define R1_MONOCHROME  (BYTE)0x01

#define R2_IN_VBLANK   (BYTE)0x80
#define R2_HIT_SP      (BYTE)0x40
#define R2_MAX_SP      (BYTE)0x20
#define R2_WRITE_FLAG  (BYTE)0x10
...
/* BG Base Address */
extern WORD *PPU_BG_Base;

/* Sprite Base Address */
extern WORD *PPU_SP_Base;

/* Sprite Height */
extern WORD PPU_SP_Height;

/* NES display size */
#define NES_DISP_WIDTH      (WORD)256
#define NES_DISP_HEIGHT     (BYTE)240
...
#else
extern WORD WorkFrame[ (long)NES_DISP_WIDTH * NES_DISP_HEIGHT ];
#endif
