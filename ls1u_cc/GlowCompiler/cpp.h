...
enum toktype {
	...
	_EQ, _NEQ, _LEQ, _GEQ, _LSH, _RSH, LAND, LOR, PPLUS, MMINUS,
	ARROW, SBRA, SKET, _LP, RP, DOT, _AND, STAR, PLUS, MINUS,
	TILDE, _NOT, SLASH, PCT, _LT, _GT, CIRC, _OR, QUEST,
	COLON, _ASGN, COMMA, SHARP, SEMIC, CBRA, CKET,
...
#define	EOB	0x7f		/* sentinel for end of input buffer */ //修改为不使用的字符以防和GB2312冲突
#define	EOFC	0xff		/* sentinel for end of input file */ //修改为不使用的字符以防和GB2312冲突
...
struct malloc_record {
	void* p;
	struct malloc_record* link;
};

extern struct malloc_record* malloc_all_p;
...
enum errtype { WARNING, _ERROR, FATAL };
